...
print("Self-diffusion constant of Hydrogen:\t%.4g +/- %.1g (%.1g%%) 10^-9 m^2/s." %(avg_diff[0]*1e4, std_diff[0]*1e4, std_diff[0]/avg_diff[0]*100))
print("Self-diffusion constant of Oxygen:\t%.4g +/- %.1g (%.1g%%) 10^-9 m^2/s.\n" %(avg_diff[1]*1e4, std_diff[1]*1e4, std_diff[1]/avg_diff[1]*100))

avg_visc = np.average(visc, 0)
std_visc = np.std(visc, 0)
# documantation: https://www.geeksforgeeks.org/numpy-std-in-python/

print("Shear viscosity of water:\t%.4g +/- %.1g (%.1g%%) Pas." %(avg_visc[0]*1.01325e-10,std_visc[0]*1.01325e-10,std_visc[0]/avg_visc[0]*100))
print("Bulk viscosity of water:\t%.4g +/- %.1g (%.1g%%) Pas.\n" %(avg_visc[1]*1.01325e-10,std_visc[1]*1.01325e-10,std_visc[1]/avg_visc[1]*100))

plot_rdf()

print("Found vs expected results")
print("Density =%10.3e vs%10.3e" %(avg_dens,0.99565))
print("Viscosity =%10.3e vs%10.3e" %(avg_visc[0]*(1.01325e-10),0.00079735))
