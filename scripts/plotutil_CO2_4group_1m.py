...
paths = ['./../data/CO2/4group/CO2_1m_20ns/run1/',
         './../data/CO2/4group/CO2_1m_20ns/run2/',
         './../data/CO2/4group/CO2_1m_20ns/run3/',
         './../data/CO2/4group/CO2_1m_20ns/run4/',
         './../data/CO2/4group/CO2_1m_20ns/run5/']
...
def plot_density():
    ...
    for i in range(len(filenames)):
        file = filenames[i]
        lines = read_file_lines(file, [0, 11], skip=250, stop=451, column_major=True)
